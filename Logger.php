...
class Logger {
    ...
    private function __construct($nameFile = 'log') {
        ...
        $this->path = realpath('.') . '/logs/'.$this->nameFile.'-' . date('Y-m-d') . '.log';
    ...
    /****   INSTANCIA    ****/
     public static function getInstancia($nameFile = 'log')
    {
        
        if (!isset(self::$instancia)) {
            $miclase = __CLASS__;
           // var_dump($miclase);
            self::$instancia = new Logger($nameFile);
